...
![The 10 scheduled palindromic primes p(n), their decimal value, the longest 1-run length k, and the binary expansion with the longest contiguous 1-run highlighted in yellow.](/media/palin-prime-bits/og_image.png)
